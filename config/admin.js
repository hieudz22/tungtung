...
ThongBao.findOne({}, function(err, data){
	if (!data) {
		ThongBao.create({'thongbao1':'Gowin88.club cổng game xanh chín uy tín nhất số 1 việt nam ', 'active':'1', 'thongbao2': 'Các siêu đại gia xuống tiền nhẹ tay cho các game thủ vào tiền nữa nhé !'});
	}
})
